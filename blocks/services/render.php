...
?>
<section id="services" class="min-h-screen w-full relative cinematic-section bg-primary py-10 md:py-16">
      ...
      <?php foreach ($categories as $category) : ?>
        <div class="bg-white p-8 flex flex-col justify-between border-t-4 border-secondary hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.5rem)] max-w-md lg:max-w-none" data-animate-item>
          <div class="mb-6">
            ...
            <h3 class="text-h3 text-primary mb-4"><?php echo esc_html($category['title']); ?></h3>
          ...
          <div>
            ...
            <div class="flex flex-col gap-2">
              <?php foreach ($category['links'] as $link) : ?>
                <div class="group flex items-center justify-between p-3 bg-[#fcf9f8] hover:bg-primary transition-all duration-300">
                  <span class="text-body-sm font-medium text-primary group-hover:text-white transition-colors"><?php echo esc_html($link['label']); ?></span>
