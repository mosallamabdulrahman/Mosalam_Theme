...
<section class="relative h-[450px] flex items-center overflow-hidden bg-primary">
  <div class="absolute inset-0 z-0">
    <img class="w-full h-full object-cover opacity-40 mix-blend-overlay" alt="Sophisticated server room with deep blue ambient lighting" src="<?php echo esc_url($background_image); ?>" referrerpolicy="no-referrer" loading="eager" fetchpriority="high">
